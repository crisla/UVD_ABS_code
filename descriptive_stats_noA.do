...
********************************************************************************
* DESCRIPTIVE STATS FILE II (EXCLUDING SELF-EMPLOYED, AFTER 1994)
********************************************************************************
* Composition II
****************************************************

log using ./results/descriptive_stats84_noA.log, replace
// log using ./results/descriptive_stats96_noA.log, replace
log off

use "./MS84noA.dta", clear
